...
class Hexagon(_Symbol):
    ...
    def draw(self):
        ...
        g.add(l3)
        l4 = shapes.Line(xr + strokedx, self.y, xr - dx + strokedx, self.y - dy, strokeColor = white, strokeWidth = strokew, strokeLineCap = 1)
        g.add(l4)
...
renderPDF.drawToFile(d, 'PDF/ReggaeStroke.pdf')
