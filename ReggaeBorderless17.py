...
def drawLegendLines(d, i):
    ...
    d.add(String(leftmargin + float(legendsdata[i][1]) - dx - 10.0 + 0.5 * (maxnamewidth - namewidth), bottommargin + float(legendsdata[i][2]) - 83, legendsdata[i][0], fontName = 'Courier', fillColor = orange, fontSize = 12))
    return
