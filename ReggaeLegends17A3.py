...
d.add(transform_svg("cannabis.svg", 85.0, 612, 0.035, 0.035))
d.add(transform_svg("cannabis.svg", 115.0, 612, 0.035, 0.035))
d.add(transform_svg("cannabis.svg", 145.0, 612, 0.035, 0.035))
for i in range(len(legendsdata)):
    drawLegendLines(d, i)
