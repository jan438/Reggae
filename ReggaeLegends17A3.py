...
d.add(transform_svg("rasta.svg", 130.0, 740.0, 0.55, 0.55))
d.add(transform_svg("cannabis.svg", 90.0, 620, 0.035, 0.035))
d.add(transform_svg("cannabis.svg", 100.0, 620, 0.035, 0.035))
d.add(transform_svg("cannabis.svg", 110.0, 620, 0.035, 0.035))
for i in range(len(legendsdata)):
    drawLegendLines(d, i)
