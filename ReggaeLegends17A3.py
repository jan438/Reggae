...
d.add(transform_svg("cannabis.svg", 90.0, 617, 0.035, 0.035))
d.add(transform_svg("cannabis.svg", 100.0, 617, 0.035, 0.035))
d.add(transform_svg("cannabis.svg", 110.0, 617, 0.035, 0.035))
for i in range(len(legendsdata)):
    drawLegendLines(d, i)
